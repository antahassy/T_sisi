    ...
    function level_grup(){
        $.ajax({
            ...
            error: function (error){
                send_error(error, site + '/group_admin', form_data = '-');
            }
        });
    }
    function main(){
                ...
                onOpen  : function(){
                    ...
                    setTimeout(function(){
                        $.ajax({
                            ...
                            error   : function(error){
                                send_error(error, site + '/list_admin/' + action_data.id + '/edit', form_data = '-');
                            }
                        });
                    },300);
                }
                        ...
                        onOpen  : function(){
                            ...
                            setTimeout(function(){
                                $.ajax({
                                    ...
                                    error: function (error){
                                        send_error(error, site + '/list_admin/hapus', action_data.id);
                                    }
                                });
                            },300);
                        }
