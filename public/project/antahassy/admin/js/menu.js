    ...
    function rel_menu(rel_val){
        $.ajax({
            ...
            error: function (error){
                send_error(error, site + '/menu_admin/rel_menu', form_data = '-');
            }
        });
    }
    function main(){
                ...
                onOpen  : function(){
                    ...
                    setTimeout(function(){
                        $.ajax({
                            ...
                            error: function (error){
                                send_error(error, site + '/menu_admin/' + action_data.id + '/edit', form_data = '-');
                            }
                        });
                    },300);
                }
                        ...
                        onOpen  : function(){
                            ...
                            setTimeout(function(){
                                $.ajax({
                                    ...
                                    error: function (error){
                                        send_error(error, site + '/menu_admin/hapus', action_data.id);
                                    }
                                });
                            },300);
                        }
