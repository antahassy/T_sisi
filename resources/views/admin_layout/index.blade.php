<?php
	$meta = DB::table('tb_user_setting')->get();
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="background: rgb(25,25,25);">
                            <ul class="menu-nav" style="padding: 0;">
                                ...
                                <?php
									$menu = DB::table('tb_user_rel_group')
										->orderBy('tb_user_menu.urutan','asc')
										->select('tb_user_menu.id', 'tb_user_menu.menu', 'tb_user_menu.url', 'tb_user_menu.rel')
										->where('tb_user_rel_group.id_group', $id_group)
										->where('tb_user_rel_group.akses', '1')
										->where('tb_user_rel_group.deleted_at', null)
										->where('tb_user_menu.rel', '0')
										->where('tb_user_menu.deleted_at', null)
										->join('tb_user_menu', 'tb_user_rel_group.id_menu', '=', 'tb_user_menu.id')
										->get();
									$arr_id = array();
                                    ...
                                    foreach ($menu as $row_menu) {
                                        $id = $row_menu->id;
                                        $sub_menu = DB::table('tb_user_rel_group')
                                        ->orderBy('tb_user_menu.urutan','asc')
										->select('tb_user_menu.id', 'tb_user_menu.menu', 'tb_user_menu.url', 'tb_user_menu.rel')
										->where('tb_user_rel_group.id_group', $id_group)
										->where('tb_user_rel_group.akses', '1')
